...
from gitbranchpruner import _version
from gitbranchpruner.resources import get_resource_path

APP_NAME = f'Gitbranchpruner-{_version}'
APP_ICON = get_resource_path('gitbranchpruner.ico')
